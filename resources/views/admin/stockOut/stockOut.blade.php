...
<div class="row mb-2">
  <div class="col-sm-6">
    <h1 class="m-0 text-dark">Stock Outs</h1>
  </div>
  <!-- /.col -->
  <div class="col-sm-6">
    <ol class="breadcrumb float-sm-right">
      <li class="breadcrumb-stockOut"><a href="#">Admin</a></li>
      <li class="breadcrumb-stockOut active">Stock Outs</li>
    </ol>
  </div>
  <!-- /.col -->
</div>
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <!-- <h3 class="card-title">StockOuts</h3> -->
              ...
              @if(count($stockOuts) > 0)
                @foreach($stockOuts as $stockOut)
                  <tr role="row" class="odd">
                    ...
                    <td>
                      <!-- Detail -->
                      <a href="#" class="detailButton" data-id="{{$stockOut->id}}">
                ...
                @endforeach
              @else
                <tr><td colspan="5"><h6 align="center">No stockOut(s) found</h6></td></tr>
              @endif
            </tbody>
            <tfoot>
              <!-- <tr>
