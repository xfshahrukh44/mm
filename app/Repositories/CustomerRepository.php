...
abstract class CustomerRepository implements RepositoryInterface
{
    ...
    public function find($id)
    {
        // try 
        // {
            $customer = $this->model::with('market.area', 'special_discounts.product', 'ledgers.invoice.invoice_products', 'invoices.invoice_products', 'customer_images', 'ledgers.expense')->find($id);
            if(!$customer)
            {
                return [
                    'success' => false,
